...
:CreateCompilerPath
	...
	if "%Directory%"=="" (
		...
		if "%PROCESSOR_ARCHITECTURE%"=="x86" (
			...
			REM set GccFilePath="%ProgramFiles%\mingw-w64\x86_64-8.1.0-posix-seh-rt_v6-rev0\mingw64\bin\gcc.exe"
			REM set AssemblerFilePath="%ProgramFiles%\mingw-w64\x86_64-8.1.0-posix-seh-rt_v6-rev0\mingw64\bin\as.exe"
			REM set LinkerFilePath="%ProgramFiles%\mingw-w64\x86_64-8.1.0-posix-seh-rt_v6-rev0\mingw64\bin\ld.exe"
			REM set DllToolFilePath="%ProgramFiles%\mingw-w64\x86_64-8.1.0-posix-seh-rt_v6-rev0\mingw64\bin\dlltool.exe"
			REM set ArchiveCompilerFilePath="%ProgramFiles%\mingw-w64\x86_64-8.1.0-posix-seh-rt_v6-rev0\mingw64\bin\ar.exe"
...
:GccLinker
	...
	set WinApiObjectLibraries=-ladvapi32 -lcards -lcomctl32 -lcomdlg32 -lcrypt32 -lgdi32 -lgdiplus -limm32 -lkernel32 -lmsimg32 -lmsvcrt -lmswsock -lole32 -loleaut32 -lshell32 -lshlwapi -luser32 -lversion -lwinmm -lwinspool -lws2_32
	...
	%LinkerFilePath% -m %PEFileFormat% -o %CompilerOutputFileName% -subsystem %Win32Subsystem% -e %EntryPoint% --stack 1048576,1048576 %LinkerStripFlag% -L %CompilerLibDirectoryPath% -L "." %AllObjectFiles% -( %AllObjectLibraries% -)
...
:GccCompier
	...
	if "%CodeGenerationBackend%"=="gcc" (
		REM replace.vbs %FileWithExtensionC%
